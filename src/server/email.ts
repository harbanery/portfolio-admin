...
/**
 * Service pengiriman email via Nodemailer (SMTP) — pola dari progress-self.
 *
 * Dipakai untuk mengirim password admin hasil generate (khusus development).
...
/**
 * Kirim email ke penerima yang dikonfigurasi.
